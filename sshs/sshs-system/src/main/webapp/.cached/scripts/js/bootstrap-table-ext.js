/**
 * ajax获取后台数据 paginator插件扩展，以增加通用性
 * author:Suny
 * date:2017-10-10
 */
$.fn.extend({
	...
	loadData : function(params) {
		...
		$(this).bootstrapTable({
			...
			method : $(this).data("method") ? $(this).data("method") : 'get', //请求方式（*）
			...
			contentType : "application/json", // "application/x-www-form-urlencoded", //请求数据内容格式 默认是 application/json 自己根据格式自行服务端处理
