				...
				$(this).bootstrapTable(
						{
							url : $(this).data("url") ? $(this).data("url")
									: "", // 请求后台的URL（*）
							method : $(this).data("method") ? $(this).data(
									"method") : 'post', // 请求方式（*）
							toolbar : $(this).data("toolbar") ? '#'+$(this).data(
									"toolbar") : '#toolbar', // 工具按钮用哪个容器
							striped : $(this).data("striped") ? $(this).data(
									"striped") : false, // 是否显示行间隔色
							cache : false, // 是否使用缓存，默认为true，所以一般情况下需要设置一下这个属性（*）
							pagination : $(this).data("pagination") ? $(this)
									.data("pagination") : false, // 是否显示分页（*）
							...
							showToggle : $(this).data("showToggle") ? $(this)
									.data("showToggle") : false, // 是否显示详细视图和列表视图的切换按钮
