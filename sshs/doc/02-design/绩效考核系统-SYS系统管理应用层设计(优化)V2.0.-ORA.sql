...
CONSTRAINT SYS_USER PRIMARY KEY (USER_ID)
 ...
 COMMENT ON TABLE SYS_USER IS '系统管理-用户表';
...
COMMENT ON COLUMN SYS_USER.POLITICAL_STATUS IS  '政治面貌:团员、党员、其他党派人士、无党派';
COMMENT ON COLUMN SYS_USER.PARTY_TIME IS  '入党时间';
COMMENT ON COLUMN SYS_USER.MARITAL_STATUS IS  '婚姻状况:10-未婚；20-已婚；21-离婚；40-丧偶；';
COMMENT ON COLUMN SYS_USER.BLOOD_TYPE IS  '血型:A型、B型、AB型、O型、未知血型';
COMMENT ON COLUMN SYS_USER.ENGLISH_LEVEL IS  '英语等级';
COMMENT ON COLUMN SYS_USER.COMPUTER_LEVEL IS  '计算机等级';
COMMENT ON COLUMN SYS_USER.WORK_TIME IS  '参加工作年月';
COMMENT ON COLUMN SYS_USER.INDUCTION_TYPE IS  '入职类型:社会招录、资源性人才引进、系统内调入、系统外调入';
COMMENT ON COLUMN SYS_USER.EMPLOY_WAY IS  '用工方式:合同制员工
派遣制员工
实习员工';
COMMENT ON COLUMN SYS_USER.EMP_STATUS IS  '员工状态:在职在岗
在编不在岗的
离岗退养
转非
退休
...
COMMENT ON COLUMN SYS_USER.HEIGHT IS  '身高';
COMMENT ON COLUMN SYS_USER.WEIGHT IS  '体重';
COMMENT ON COLUMN SYS_USER.CHILD_NUM IS  '子女人数';
COMMENT ON COLUMN SYS_USER.HEALTH_STATE IS  '健康状况:健康
一般
慢性疾病
生理缺陷
残废
较弱';
COMMENT ON COLUMN SYS_USER.HIGHEST_EDU IS  '最高学历:中专、高中、大专、专科、本科、研究生（硕士）、研究生（博士）';
COMMENT ON COLUMN SYS_USER.HIGHEST_DEGREE IS  '最高学位:0-其他；1-名誉博士；
2-博士；
3-硕士；
4-学士；
9-未知。';
...
COMMENT ON COLUMN SYS_USER.CONTACT_ADDRESS IS  '通讯地址';
COMMENT ON COLUMN SYS_USER.POSTCODE_CONTACT IS  '通讯地址邮编';
COMMENT ON COLUMN SYS_USER.RESIDENTIAL_ADDRESS IS  '现居住地址';
COMMENT ON COLUMN SYS_USER.POSTCODE_RESIDENTIAL IS  '现居住地邮编';
COMMENT ON COLUMN SYS_USER.DOMICILE_ADDRESS IS  '户籍所在地';
COMMENT ON COLUMN SYS_USER.POSTCODE_DOMICILE IS  '户籍所在地邮编';
COMMENT ON COLUMN SYS_USER.HOUSEHOLD_REG IS  '户籍类型:城镇,非城镇';
COMMENT ON COLUMN SYS_USER.EMAIL IS  '电子邮箱';
COMMENT ON COLUMN SYS_USER.MOBILE_PHONE IS  '手机';
COMMENT ON COLUMN SYS_USER.HOME_TELPHONE IS  '家庭电话';
COMMENT ON COLUMN SYS_USER.EMERGENCY_CONTACT IS  '紧急联系人';
COMMENT ON COLUMN SYS_USER.EMERGENCY_CONTACT_PHONE IS  '紧急联系人手机';
COMMENT ON COLUMN SYS_USER.QQ IS  'QQ号';
COMMENT ON COLUMN SYS_USER.WECHAT IS  '微信号';
...
COMMENT ON COLUMN SYS_USER.C5 IS  '备用字段1';
COMMENT ON COLUMN SYS_USER.C6 IS  '备用字段2';
COMMENT ON COLUMN SYS_USER.C7 IS  '备用字段3';
COMMENT ON COLUMN SYS_USER.C8 IS  '备用字段4';
COMMENT ON COLUMN SYS_USER.C9 IS  '备用字段5';
COMMENT ON COLUMN SYS_USER.C10 IS  '备用字段6';
...
COMMENT ON COLUMN SYS_CODER.DICT_CODE IS  '字典类型值';
