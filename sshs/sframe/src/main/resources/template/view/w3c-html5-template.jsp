...
<!-- bootstrap-table -->
<link href="aframe/bootstrap-table/src/bootstrap-table.css"
	rel="stylesheet">
<!-- bootstrap-select -->
<link rel="stylesheet"
	href="aframe/bootstrap-select/dist/css/bootstrap-select.css">

<!-- bootstrap-datetimepicker -->
<link rel="stylesheet"
	href="aframe/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css">
...
<!-- bootstrap-datetimepicker -->
<script type="text/javascript"
	src="aframe/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js"
	charset="UTF-8"></script>
<script type="text/javascript"
	src="aframe/bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js"
	charset="UTF-8"></script>
<script type="text/javascript"
	src="aframe/bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js"
	charset="UTF-8"></script>
...
<!-- 自定义js ，扩展翻页table组件 -->
<script type="text/javascript" src="aframe/js/bootstrap-table-ext.js"></script>
<!--_PageHeader-->
</head>
<body>
	<!--_PageBody-->
