package com.sshs.sframe.base.service.impl;
...
import com.sshs.sframe.base.service.IBaseService;
		...
		try {
			...
			if (authType != null && !authType.contains(",A,")) {
				...
				if (getLegalOrg != null && getLegalOrg.invoke(object) == null) {
					Method setLegalOrg = clazz.getDeclaredMethod("setLegalOrg",
							String.class);
					if (setLegalOrg != null) {
